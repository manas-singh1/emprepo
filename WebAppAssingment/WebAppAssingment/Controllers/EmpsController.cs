...
namespace WebAppAssingment.Controllers
{
    public class EmpsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EId,EName,EmployeeId,EDesign,EDoj")] Emp emp)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EId,EName,EmployeeId,EDesign,EDoj")] Emp emp)
        {
            if (id != emp.EId)
            {
                return NotFound();
